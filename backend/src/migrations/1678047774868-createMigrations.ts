...
export class createMigrations1678047774868 implements MigrationInterface {
    name = 'createMigrations1678047774868'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "announcements" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "model" character varying(60) NOT NULL, "type" character varying(150) NOT NULL, "description" character varying, "km" integer NOT NULL, "year" integer NOT NULL, "default_img" character varying(220) NOT NULL, "images" text NOT NULL, "price" double precision NOT NULL, "isActive" boolean NOT NULL DEFAULT 'true', "userId" uuid, CONSTRAINT "PK_b3ad760876ff2e19d58e05dc8b0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL, "name" character varying(200) NOT NULL, "abbreviation" character varying(2) NOT NULL, "email" character varying(200) NOT NULL, "cpf" character varying(50) NOT NULL, "phone" character varying(50) NOT NULL, "dateOfBirth" character varying(50) NOT NULL, "descripition" character varying(200) NOT NULL, "seller" boolean NOT NULL, "password" character varying(150) NOT NULL, "register" TIMESTAMP NOT NULL DEFAULT '"2023-03-05T20:22:57.985Z"', "resetCode" character varying(8), "addressId" uuid, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "UQ_a6235b5ef0939d8deaad755fc87" UNIQUE ("cpf"), CONSTRAINT "REL_217ba147c5de6c107f2fa7fa27" UNIQUE ("addressId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
