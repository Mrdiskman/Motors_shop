...
export class createMigrations1677848993188 implements MigrationInterface {
    name = 'createMigrations1677848993188'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL, "name" character varying(24) NOT NULL, "abbreviation" character varying(2) NOT NULL, "email" character varying(20) NOT NULL, "cpf" character varying(11) NOT NULL, "phone" character varying(11) NOT NULL, "dateOfBirth" character varying(10) NOT NULL, "descripition" character varying(150) NOT NULL, "seller" boolean NOT NULL, "password" character varying(150) NOT NULL, "register" TIMESTAMP NOT NULL DEFAULT '"2023-03-03T13:09:56.053Z"', "addressId" uuid, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "UQ_a6235b5ef0939d8deaad755fc87" UNIQUE ("cpf"), CONSTRAINT "REL_217ba147c5de6c107f2fa7fa27" UNIQUE ("addressId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
